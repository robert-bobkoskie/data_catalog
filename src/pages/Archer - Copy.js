...
const Game = () => {
  ...
  const [redFrequency, setRedFrequency] = useState(20000); // Start with the easier setting
  ...
  const fireProjectile = useCallback(() => {
    setProjectiles(prevProjectiles => [...prevProjectiles, { x: 10, y: blackY + 5 }]); // Adjust y to fire from the vertex
  }, [blackY]);
    ...
    <div className="game-container">
      <div className="controls">
        ...
        <div>
          ...
          <input type="range" min="5000" max="20000" value={redFrequency} onChange={e => setRedFrequency(parseInt(e.target.value))} />
        </div>
